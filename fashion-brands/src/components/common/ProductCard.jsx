...
function ProductCard({ product, showCollection = true }) {
  ...
  const handleWishlist = (e) => {
    e.preventDefault();
    setWishlisted((v) => !v);
    showToast(wishlisted ? "\u0110\xE3 x\xF3a kh\u1ECFi danh s\xE1ch y\xEAu th\xEDch" : "\u0110\xE3 th\xEAm v\xE0o danh s\xE1ch y\xEAu th\xEDch");
  };
  ...
  /> : <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#1f1e1d] to-[#0e0e0e]">
            <span className="text-[#3a3830] text-xs tracking-widest uppercase font-serif">ATELIER</span>
          </div>}
