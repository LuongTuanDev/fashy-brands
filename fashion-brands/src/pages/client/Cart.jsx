...
function CartPage() {
      ...
      <main className="pt-[68px]">
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-12">
          <div className="mb-8">
            ...
            <p className="text-[10px] tracking-[0.3em] uppercase text-[#5a5248]">Curated for the Digital Atelier</p>
          </div>
  ...
  >
                  ...
                  <p className="text-[9px] text-[#3a3830] mt-1 tracking-wide">Thử: ATELIER10 / LUXURY20 / VIP15</p>
                </div>
              </div>
